...
public class UserInputService {
	...
	public void updateUserInputs(String userName, int recordId, Map<Integer, String> updatedFields) {
		for (Map.Entry<Integer, String> entry : updatedFields.entrySet()) {
			...
			userInputRepository.updateUserInput(fieldValue, recordId, userName, fieldId); // Ensure this line matches
																							// the method signature
		}
	}

	@Transactional
	public void deleteUserInputsByRecordId(int recordId) {
		userInputRepository.deleteByRecordId(recordId);
	}
